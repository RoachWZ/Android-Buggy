...
public class VideoRCcarSendChatViewActivity extends AppCompatActivity {
    private String channelName = "demoChannel1";
    private String selfName = "1";
    private String appID = "";

    private static final String LOG_TAG = VideoRCcarSendChatViewActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_rc_car_ctrl);
